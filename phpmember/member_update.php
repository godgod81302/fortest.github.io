...
if(isset($_POST["action"])&&($_POST["action"]=="update")){	
	$query_update = "UPDATE memberdata SET m_passwd=?, m_name=?, m_sex=?, m_birthday=?, m_email=?, m_url=?, m_phone=?, m_address=? ,m_jointime =NOW() WHERE m_id=?";
      ...
      <tr valign="top">
        ...
        <div class="regbox">
          <p class="heading"><strong>會員系統</strong></p>
            ...
            <p>您今日登入了 <?php echo $row_RecMember["m_login"];?> 次。<br>
            本次登入的時間為：<br>
